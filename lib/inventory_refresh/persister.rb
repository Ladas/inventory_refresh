...
module InventoryRefresh
  class Persister
    ...
    attr_accessor :refresh_state_uuid, :refresh_state_part_uuid, :total_parts
    ...
    def sweep_inactive_records!
      ...
      # upsert_refresh_state(:state => :partial_error, :error_message => "X parts were not successfully saved")
      #
      # if sweeping_not_ready
      #   raise SweepingNotReady
      # end
      refresh_state.update_attributes!(:status => :sweeping, :total_parts => total_parts)
